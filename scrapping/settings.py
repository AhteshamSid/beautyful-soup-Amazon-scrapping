"""
Django settings for scrapping project.
...
if DEBUG:
    SECRET_KEY = 'django-insecure-&=jz%@1&gn4xvm%)lb72(p!3ds@!rzz&00iiq5q*eotu+_=)zg'
else:
    SECRET_KEY = os.environ['SECRET_KEY']
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'djangowebscrapping.herokuapp.com']
...
DATA_UPLOAD_MAX_NUMBER_FIELDS = 1025
